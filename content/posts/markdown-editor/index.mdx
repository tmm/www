...
This is the best so far. (In fact, we could stop here since iA Writer is a fantastic piece of software.) But it's not perfect: Showing syntax and preview at the same time is redundant.
...
It's worth noting that despite stripping characters, WYSIWYG editors handle preview the best because you are writing in rich text.
...
The video is a recording of a no-frills editor I hacked up to experiment with these two concepts. I'll save implementation details for future post.[^1]

If you are unsure why this a better than editors that already do block or inline previews
consider the following scenario: A large paragraph with a few links scattered
throughout.
...
Inline previews don't hide syntax so you have URLs taking up space in between words.
