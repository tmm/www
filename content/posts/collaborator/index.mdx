...
work together. If Apple wasn't a success, maybe they would have forever
...
but aren't that important. Location doesn't matter.
...
A little about me: I'm an engineer and ocassional designer. I mostly build for
the web, although I've made mobile apps in the past. I'm comfortable with
frontend, backend, and devops. Currently, I work on
[Patreon](https://patreon.com) remotely from NYC. A few projects I'm proud of are
[Mute.vc](https://mute.vc), [Notational](https://notational.co), and [this
blog](https://meagher.co).

If working together sounds interesting, or you have a friend that might
be interested, send me an email (<CopyEmailButton />) or [Twitter
...
[^2]: We'll need to trust each other and give/receive feedback so it's
  important we can feel for each other too.
